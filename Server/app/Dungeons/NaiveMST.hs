-------------------------------------------------------------------------------
-- Changes by me (deeliciouscode):
-- Only changed the Delaunay Implementation because the Default one
-- was buggy and didn't terminate when trying to calculate the triangles for 
-- more than 10 - 15 Points (it varied). 
-------------------------------------------------------------------------------
